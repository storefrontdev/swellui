...
${incompatibleFields} `;
    ...
    IncompatibleFieldDataError.fail = ({ incompatibleFieldData, }) => (T.chain_(getDocumentContext, (documentContext) => T.fail(new FetchDataError.IncompatibleFieldDataError({
        documentFilePath: documentContext.relativeFilePath,
        documentTypeDef: documentContext.documentTypeDef,
        incompatibleFieldData,
    }), fileName_1 + ":366:17"), fileName_1 + ":365:16"));
