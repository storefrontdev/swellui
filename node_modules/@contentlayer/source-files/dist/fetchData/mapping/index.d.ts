...
type MakeDocumentInternalError = core.UnexpectedMarkdownError | core.UnexpectedMDXError | FetchDataError.NoSuchNestedDocumentTypeError | FetchDataError.IncompatibleFieldDataError | FetchDataError.ImageError;
export declare const getFlattenedPath: (relativeFilePath: string) => string;
export declare const testOnly_getDataForFieldDef: ({ fieldDef, rawFieldData, isRootDocument, coreSchemaDef, options, documentFilePath, contentDirPath, }: {
