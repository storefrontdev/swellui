...
export declare class DevCommand extends BaseCommand {
    static paths: string[][];
    static usage: Usage;
    executeSafe: () => T.Effect<import("@contentlayer/utils/effect").Has<core.Cwd> & OT.HasTracer & import("@contentlayer/utils/effect").Has<import("@contentlayer/utils/effect/ConsoleService.js").ConsoleService> & core.HasCwd & import("@contentlayer/utils/effect").Has<OT.Tracer> & import("@contentlayer/utils/effect").HasClock & import("@contentlayer/utils/effect").HasConsole, import("@contentlayer/utils/node/fs.js").RmError, void>;
}
